          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-12 h-12 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-brand-red transition-all duration-300 transform hover:scale-110">
