    ...
    <section className="py-20 bg-gradient-to-br from-brand-red via-brand-red-light to-brand-red text-white relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left Content */}
          <div className="space-y-8 text-center items-center flex flex-col lg:text-left lg:items-start">
          ...
          {/* Right Content */}
          <div className="space-y-6 text-center items-center flex flex-col lg:text-left lg:items-start">
